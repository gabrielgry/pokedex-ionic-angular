...
import { IonContent, IonHeader, IonTitle, IonGrid, IonRow, IonCol, ViewWillEnter } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonCol, IonRow, IonGrid, IonContent, IonHeader, IonTitle, CommonModule, FormsModule, PokemonCardComponent, MatPaginatorModule]
})
